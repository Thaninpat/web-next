...
var AuthContextProvider = function AuthContextProvider(_a) {
  var children = _a.children;

  var _b = react_1.useState('close'),
      authAction = _b[0],
      setAuthAction = _b[1];

  var _c = react_1.useState(null),
      loggedInUser = _c[0],
      setLoggedInUser = _c[1];

  var _d = graphql_1.useMeQuery(),
      data = _d.data,
      loading = _d.loading; // if(!!loading) return <Loader/>


  react_1.useEffect(function () {
    if (data === null || data === void 0 ? void 0 : data.me) setLoggedInUser(data.me);
  }, [data === null || data === void 0 ? void 0 : data.me]); // TODO: เมื่อ signout แท็ปอื่นที่เปิดอยู่ก็จะ signout ออกไปด้วย

  react_1.useEffect(function () {
    var syncSignout = function syncSignout(e) {
      if (e.key === 'signout') {
        // Log user out
        setLoggedInUser(null); // Push user to Sign In page
